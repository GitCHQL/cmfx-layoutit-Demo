...
class AdminDemoController extends PluginController{
	...
	function index(){
		...
		$this->display(":layoutit");
	}
	function demo(){
		$htmlstring=$_POST['html'];
		//$htmlstring="123";
		/*echo SITE_PATH;*/
		
		file_put_contents(SITE_PATH."plugins/Demo/View/test.html",$htmlstring);
	}
